      ...
      <div className="contact_container container grid">
        <div className="contact_data">
          ...
          <p className="contact_description">
            Feel free to get in touch, I am always excited and open to discuss
            new projects, creative ideas or opportunities to be the part of your
            visions
          </p>
          ...
          <div className="contact_info">
            <div className="info_item">
              ...
              <div className="">
                ...
                <h4 className="info_desc">ankit9928meena@gmail.com</h4>
              </div>
            </div>
            <div className="info_item">
              ...
              <div className="">
                ...
                <h4 className="info_desc">+91 7728005909</h4>
              </div>
            </div>
          </div>
          ...
          <div className="contact_socials">
            <Link
              to="https://www.linkedin.com/in/jayantsingh1139/"
              target="_blank"
              className="contact_social_links"
            >
              <FaLinkedinIn />
            </Link>
            <Link
              to="https://www.instagram.com/jayant1139/"
              target="_blank"
              className="contact_social_links"
            >
              <FaInstagram />
            ...
            <Link
              to="https://github.com/jayant1139"
              target="_blank"
              className="contact_social_links"
            >
              <FaGithub />
